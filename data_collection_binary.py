...
#testing data
count = len(os.listdir("C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/A"))
...
cv2.imwrite("C:/Users/Hp/Desktop/Sign_to_text_or_speech/white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("C:/Users/Hp/Desktop/Sign_to_text_or_speech/white.jpg")
            # img_final=img_final1=img_final2=0
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            # test data
            count = len(os.listdir("C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/" + p_dir + "/"))
        ...
        if flag==True:
            ...
            if step%2==0:
                ...
                #             img_final)
                cv2.imwrite("C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/" + p_dir + "/" + c_dir + str(count) + ".jpg",
                            img_final1)
                cv2.imwrite(
                    "C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/" + p_dir + "/" + c_dir + str(count) + ".jpg",
                    img_final2)

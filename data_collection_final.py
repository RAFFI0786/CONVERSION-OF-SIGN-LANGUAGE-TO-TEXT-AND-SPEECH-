...
count = len(oss.listdir("C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/A/"))
c_dir = 'A'
    ...
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/" + (c_dir) + "/"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:/Users/Hp/Desktop/Sign_to_text_or_speech/AtoZ_3.1/" + (c_dir) + "/" + str(count) + ".jpg",
                            skeleton1)
